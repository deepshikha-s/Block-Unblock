        ...
        for event in pygame.event.get():
            ...
            if c == ((255,174,201,255)):
                ...
                if x1n+208 == 700:
                    ...
                    tim5 = stop-start
                    global points
                    if moves <=100 and tim5 <= 300:
                        points = (100 - moves) + ((300-tim5)/2)
...
def stats():
    stats=("No. of moves = ",str(moves),"Time taken: ", str(round(tim5,2)), "No. of points: ", str(round(points,0)))
