...
def puzzle2():
    ...
    pygame.init()
    pygame.mixer.music.load("ES_Wear Me Out (Instrumental Version) - Gamma Skies.mp3")
        ...
        for event in pygame.event.get():
            ...
            if c == ((255,174,201,255)):
                ...
                if x1n+208 == 700:
                    ...
                    tim2 = stop-start
                    global points
                    if moves <=100 and tim2 <= 300:
                        points = (100 - moves) + ((300-tim2)/2)
                    stats()
...
def stats():
    stats=("No. of moves = ",str(moves),"Time taken: ", str(round(tim2,2)), "No. of points: ", str(round(points,0)))
