...
def puzzle3():
    ...
    pygame.init()
    pygame.mixer.music.load("Let me hear you say my Name.mp3")
        ...
        for event in pygame.event.get():
            ...
            if c == ((255,174,201,255)):
                ...
                if x1n+208 == 700:
                    ...
                    tim3 = stop-start
                    global points
                    if moves <=100 and tim3 <= 300:
                        points = (100 - moves) + ((300-tim3)/2)
...
def stats():
    stats=("No. of moves = ",str(moves),"Time taken: ", str(round(tim3,2)), "No. of points: ", str(round(points,0)))
