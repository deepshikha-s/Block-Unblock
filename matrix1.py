...
def puzzle1():
    ...
    codog={'rect2':[142, 2, 68, 278], 'rect3':[212, 142, 208, 68],'rect4':[352, 72, 208, 68],'rect5':[352, 212, 68, 208],'rect6':[492, 142, 68, 278],
           'rect7':[212, 282, 68, 278],'rect8':[352, 422, 68, 278],'rect9':[72, 562, 208, 68],'rect10':[492,422,138,68]}
        ...
        for event in pygame.event.get():
            ...
            if c == ((255,174,201,255)):
                ...
                if x1n+208 == 700:
                    ...
                    tim1 = stop-start
                    global points
                    if moves <=100 and tim1 <= 300:
                        points = (100 - moves) + ((300-tim1)/2)
                    stats()
...
def stats():
    stats=("No. of moves = ",str(moves),"Time taken: ", str(round(tim1,2)), "No. of points: ", str(round(points,0)))
